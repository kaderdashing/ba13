                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                      <a class="nav-link " aria-current="page" href="{{ url('/') }}">Commander</a>
                      <a class="nav-link" href="{{ url('/kader') }}">apropos de nous</a>
                      <a class="nav-link" href="{{ url('/oeuvre') }}">ouvrage</a>
                      @guest
                      @if (Route::has('login'))
                    ...
                    <a href="{{ route('logout') }}"               onclick="event.preventDefault();
                          ...
                          <span class="nav-link rawda"><b>déconnecter</b></span>
